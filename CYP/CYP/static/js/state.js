// Recent News JS stuff *grid_image_size*!!!

var sides = $('.box-photo').width();
var tops = $('.box-photo').width() * 0.714;

console.log('figure height: ', sides);
$('.list-items figure').height(tops);
...
// document.getElementById('state-prev').onclick = function(t) {
//   if (document.getElementById('state_top_nav').classList.contains('open')) {
//     console.log("On to the Next Nav Menu Item |           Left");
//     clearTimeout(myVar);
//     myVar = setTimeout(close_stateTop_menu, 3000);
//   } else {
//     document.body.classList.toggle("nav-stateTop-open");
//     document.getElementById('state_top_nav').classList.toggle("open");
//     myVar = setTimeout(close_stateTop_menu, 3000);
//   };
//   // document.body.classList.toggle("nav-stateTop-open");
...
// };
//
// document.getElementById('state-next').onclick = function(t) {
//   if (document.getElementById('state_top_nav').classList.contains('open')) {
//     console.log("On to the Next Nav Menu Item |           Right");
//     clearTimeout(myVar);
//     myVar = setTimeout(close_stateTop_menu, 3000);
//   } else {
//     document.body.classList.toggle("nav-stateTop-open");
...
// };
//
// function close_stateTop_menu(d) {
//   document.body.classList.toggle("nav-stateTop-open");
//   document.getElementById('state_top_nav').classList.toggle("open");
// }
