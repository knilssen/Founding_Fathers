...
if (window_width > window_height){
  var scaled_value = (window_width/1.25);
}
if (window_width < window_height) {
  var scaled_value = window_width;
}
...
$('#congressionial_districts').click(function(e) {
...
function exit_view_toggle(elementID){
  ...
  setTimeout( function() { x.classList.toggle("exit_view_not_active") }, 800 );
}

function toggledisplay(elementID){
  var x = document.getElementById(elementID);
  setTimeout( function() { x.classList.toggle("map_mode_not_active") }, 800 );
}
...
$('#open-filter-scroll').click(function(e) {
  document.getElementById('open-filter-scroll').classList.remove("show"), setTimeout(function() {
    ...
    function(e) {e.classList.remove("open")}), document.getElementById('box-filters-fixed').style.position = "absolute",
