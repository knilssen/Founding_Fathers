...
urlpatterns = [
    ...
    url(r'^republican/News/republican_scroll.html$', views.republican_scroll, name = 'republican_scroll'),
    url(r'^democrat/News/democrat_scroll.html$', views.democrat_scroll, name = 'democrat_scroll'),
