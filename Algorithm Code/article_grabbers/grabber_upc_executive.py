...
more specifically for the Utah Political Capitol executive section.
...
Usage:
    ...
    python grabber_upc_executive.py [ current_time ]
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print "Usage: python grabber_upc_executive.py [ current_time ]"
    else:
        main(sys.argv[1])
