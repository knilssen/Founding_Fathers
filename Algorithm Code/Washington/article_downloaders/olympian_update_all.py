...
def main(art_id, art_image, art_text):
    # # print "\n"
    # # print "\n"
    ...
    # # print "title:   ", title`
    #
    # author = soup.find("div", class_="byline element-spacing-small").text[3:]
    # # print author
    # # print "author:  ", author
    #
    ...
    try:
        ...
        data_olympian = (art_text, art_image, str(art_id))
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 1:
        print "Usage: python updater_olympian.py"
    else:
