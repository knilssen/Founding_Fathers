...
def main():
    ...
    article_NERT_parser.main('https://www.washingtonea.org/ourvoice/post/governors-budget-goes-beyond-mccleary/', [['12', '14', '17'], ['21', '17', '46']], "Washington Education Association", allkeywords, DiffName,  "PERSON")
